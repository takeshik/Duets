...
- Amended by: [ADR-32](32_duetspad-supersede-replservice-with-new-output-model.md) — the browser-based REPL UI shape and the `ReplService` framing
...
`ReplService` framing are amended by ADR-32, which introduces DuetsPad as the
