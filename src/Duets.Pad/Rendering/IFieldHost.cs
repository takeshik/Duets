...
/// marker in Canvas and Timeline output.
/// </summary>
internal interface IFieldHost
{
    ...
    /// placement of the field's marker in Canvas and Timeline output. A no-op projection-wise when
    /// the field is not currently placed anywhere. Must never throw.
    /// </summary>
